...
This library computes contour polygons by applying the marching squares algorithm to a rectangular grid of numeric values. For example, here is Maungawhau’s topology (the classic `volcano` dataset and `terrain.colors` from R):
